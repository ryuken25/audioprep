...
export const STR = {
  ...
  jp: {
    ...
    advanced: '詳細設定', loudness: 'ラウドネス', target: 'ターゲット', truePeak: 'トゥルーピーク', lra: 'ラウドネスレンジ', audioGroup: 'オーディオ', bitrate: 'ビットレート', lowpass: 'ローパスフィルター', cutoff: 'カットオフ', audioOnly: '音声のみ（映像を捨てて .m4a 出力）', videoGroup: 'ビデオ', crf: 'CRF', maxrate: '最大レート', fpsCap: 'FPS 上限', boxW: 'ボックス幅', boxH: 'ボックス高さ', staticGroup: '静止映像', speedGroup: '速度', threadsAuto: '自動', threadsMulti: 'マルチスレッド', threadsSingle: 'シングルスレッド', matchSource: '元の解像度に合わせる', staticVideo: '1フレーム + 音声（極小ファイル）', frameAt: 'フレーム位置',
